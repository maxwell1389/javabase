...
public class LongAdderDemo {
    ...
    private volatile LongAdder lacount = new LongAdder();
    ...
    public class LongAdderThread implements Runnable {
        ...
        public void run() {
            ...
            while (v < TARGET_COUNT) {
                lacount.increment();
                v = lacount.sum();
                System.out.println("Thread:" + Thread.currentThread() + ", v:" + v);
            }
            long endtime = System.currentTimeMillis();
            System.out.println("Thread:" + Thread.currentThread() +  ", spend:" + (endtime - starttime) + "ms" + " v" + v);
            cdladdr.countDown();
        }
